$(document).ready(function () {
   ...
   $(soc1).click(function () {
      ...
      $('#input__telegram, .form__btn').css({
         'display': 'block',
      });
      $('#input__telefon,#input__whatsapp').css({
         'display': 'none',
      });
      $('.last__label').css({
         'height': '60px',
      });
      $('#input__telegram').attr('required', 'required');
      $('#input__whatsapp').removeAttr('required')
      $('#input__telefon').removeAttr('required')
   });
   $(soc2).click(function () {
      $(this).addClass('social__item-active');
      $('#item__telegram').removeClass('social__item-active');
      $('#item__tel').removeClass('social__item-active');
      $('#input__whatsapp, .form__btn').css({
         'display': 'block',
      });
      ...
      $('#input__telegram').removeAttr('required')
